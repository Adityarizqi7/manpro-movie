...
export default function BtnSosmedShare({ classBtnShare, title, fill, size }) {
    ...
    return (
        <>
            <div className={`${classBtnShare} box-icon-share gap-6`}>
                <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${window.location.href}&text=${title}`}
                    target='_self'
                    rel='noopener noreferrer'
                    className='icon-share-facebook cursor-pointer'
                    data-tip='Facebook'
                >
                    <svg
                ...
                <a
                    ...
                    target='_self'
                    rel='noopener noreferrer'
                    className='icon-share-twitter cursor-pointer'
                    data-tip='Twitter'
                >
                    <svg
                        xmlns='http://www.w3.org/2000/svg'
                ...
                <a
                    ...
                    target='_self'
                    rel='noopener noreferrer'
                    className='icon-share-linkedin cursor-pointer'
                    data-tip='Linkedin'
                >
                    <svg
                        xmlns='http://www.w3.org/2000/svg'
                ...
                <a
                    ...
                    target='_self'
                    rel='noopener noreferrer'
                    className='icon-share-whatsapp cursor-pointer'
                    data-tip='Whatsapp'
                >
                    <svg
                        xmlns='http://www.w3.org/2000/svg'
