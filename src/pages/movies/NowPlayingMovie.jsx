                ...
                <section id='nowplaying_container_movies'>
                    ...
                    <div className='search-movies montserrat mb-10'>
                        <div className="box-search md:w-[35%] w-full inter relative">
                            <input type="text" name="search-movie" autoComplete='off' className={`${focusInput ? 'border-b-[rgb(72, 96, 228)]' : false} md:w-[35%] w-full pr-[3rem]`} placeholder="Cari movie yang sedang tayang ..." onChange={handleChange} ref={inputRef} value={searchMovie} />
                            {
                                searchMovie !== '' &&
                                <>
